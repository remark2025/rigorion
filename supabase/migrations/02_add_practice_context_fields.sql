...
-- Add practice session context columns
...
-- Create indexes for efficient querying of practice data
...
-- Create analytics view for practice sessions
...
COMMENT ON VIEW public.practice_session_analytics IS 'Analytics for complete practice sessions with performance metrics';
