...
export const PracticeHeader = ({ 
  ...
  return (
    <header className={`sticky top-0 z-50 border-b px-1 sm:px-2 md:px-4 py-2 sm:py-3 flex items-center justify-between shadow-sm transition-all duration-300 overflow-hidden ${
