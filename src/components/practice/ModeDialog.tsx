              ...
              <div>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="easy" className={isDarkMode ? 'text-green-400' : 'text-black'}>Easy - Beginner level questions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="medium" id="medium" />
                    <Label htmlFor="medium" className={isDarkMode ? 'text-green-400' : 'text-black'}>Medium - Intermediate level questions</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="hard" id="hard" />
                    <Label htmlFor="hard" className={isDarkMode ? 'text-green-400' : 'text-black'}>Hard - Advanced level questions</Label>
                  </div>
                </RadioGroup>
              </div>
            )}
